...
var main = function () {
  ...
  //InsiderTradeAPI 부분
  {
    ...
    var updateInsiderTradeAPI = function () {
      console.log(1);
            ...
            case 1:
              ...
              totalStockData.map(function (aStockData) {
                ...
                insiderTrade.createRouter(ticker, function (req, res) {
                  ...
                  if (from != undefined) {
                    stockInfo =
                      stockInfo === null || stockInfo === void 0
                        ? void 0
                        : stockInfo.filter(function (data) {
                            return dateForm(data.date) >= Number(from);
                          });
                  }
                  if (to != undefined) {
                    stockInfo =
                      stockInfo === null || stockInfo === void 0
                        ? void 0
                        : stockInfo.filter(function (data) {
                            return dateForm(data.date) <= Number(to);
                          });
                  }
                  res.json(stockInfo);
                });
    ...
    FormatConversion_1.setTimer_loop(
      FormatConversion_1.ms2hour(12),
      updateInsiderTradeAPI
    );
  }
  // WebtoonAPI 부분
  {
    var webtoonWorker_1 = pathDir("./korean-webtoon-api/index.ts");
    var updateWebtoonAPI = function () {
      console.log(2);
      return __awaiter(void 0, void 0, void 0, function () {
            ...
            case 1:
              ...
              webtoon.createRouter("info", function (req, res) {
                ...
                if (weeknum != undefined) {
                  webtoonInfo = webtoonInfo.filter(function (aWebtoonInfo) {
                    return aWebtoonInfo.weekday == Number(weeknum);
                  });
                }
                if (service != undefined) {
                  webtoonInfo = webtoonInfo.filter(function (aWebtoonInfo) {
                    return aWebtoonInfo.service == service;
                  });
                }
    ...
    FormatConversion_1.setTimer_loop(
      FormatConversion_1.ms2minute(10),
      updateWebtoonAPI
    );
  }
  //Covid19API 부분
            ...
            case 1:
              ...
              wokrer_data.map(function (covidData) {
                covid19.createRouter(covidData.region, function (req, res) {
                  ...
                  var to = req.query.to;
                  if (from != undefined) {
                    covidInfo = covidInfo.filter(function (data) {
                      return dateForm(data.date) >= Number(from);
                    });
                  }
                  if (to != undefined) {
...
var dateForm = function (date) {
  return Number(FormatConversion_2.convertDateFormat(date, ""));
