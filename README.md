...
|           Name            | Required |  Type   | Default | Sample                                                                                                             | Description                                                                                                                                                                                                        |
| :-----------------------: | :------: | :-----: | :-----: | :----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
|   **totalWebtoonCount**   |    Y     | number  |    0    | 5430                                                                                                               | 전체 웹툰 수                                                                                                                                                                                                       |
|   **naverWebtoonCount**   |    Y     | number  |    0    | 2032                                                                                                               | 네이버 웹툰 수                                                                                                                                                                                                     |
|   **kakaoWebtoonCount**   |    Y     | number  |    0    | 1542                                                                                                               | 카카오 웹툰 수                                                                                                                                                                                                     |
| **kakaoPageWebtoonCount** |    Y     | number  |    0    | 1856                                                                                                               | 카카오 페이지 웹툰 수                                                                                                                                                                                              |
|      **isLastPage**       |    N     | boolean |  null   | false                                                                                                              | 마지막 페이지 여부                                                                                                                                                                                                 |
|      **lastUpdate**       |    N     | string  |  null   | 2022-12-01T01:41:51.421Z                                                                                           | 마지막 갱신 시간                                                                                                                                                                                                   |
|  **updatedWebtoonCount**  |    Y     | number  |    0    | 43                                                                                                                 | 마지막 갱신에서 정보가 변경된 웹툰 수                                                                                                                                                                              |
|  **createdWebtoonCount**  |    Y     | number  |    0    | 2                                                                                                                  | 마지막 갱신에서 정보가 새롭게 생성된 웹툰 수                                                                                                                                                                       |
|         **\_id**          |    Y     | string  |    -    | 63824f5799624044b9326032                                                                                           | 객체 ID                                                                                                                                                                                                            |
|       **webtoonId**       |    Y     | number  |    -    | 1000000318995                                                                                                      | 웹툰 고유 ID <ul><li>**네이버** 1000000000000~ </li><li>**카카오** 2000000000000~</li><li>**카카오 페이지** 3000000000000~</li></ul>                                                                               |
|         **title**         |    Y     | string  |    -    | 갓 오브 하이스쿨                                                                                                   | 웹툰 제목                                                                                                                                                                                                          |
|        **author**         |    Y     | string  |    -    | 박용제                                                                                                             | 웹툰 작가                                                                                                                                                                                                          |
|          **url**          |    Y     | string  |    -    | https://m.comic.naver.com/webtoon/list?titleId=318995                                                              | 웹툰 URL                                                                                                                                                                                                           |
|          **img**          |    Y     | string  |    -    | https://image-comic.pstatic.net/webtoon/318995/thumbnail/thumbnail_IMAG21_38f18e00-09f2-4a0c-b36a-3aa56dfe0b3b.jpg | 웹툰 썸네일 이미지                                                                                                                                                                                                 |
|        **service**        |    Y     | string  |    -    | naver                                                                                                              | 웹툰 공급자<ul><li>`naver` 네이버 웹툰</li><li>`kakao` 카카오 웹툰</li><li>`kakaoPage` 카카오페이지</li></ul>                                                                                                      |
|      **updateDays**       |    Y     |  array  |    -    | ["finished"]                                                                                                       | 웹툰 업데이트 구분 목록<ul><li>`mon` 월</li><li>`tue` 화</li><li>`wed` 수</li><li>`thu` 목</li><li>`fri` 금</li><li>`sat` 토</li><li>`sun` 일</li><li>`finished` 완결</li><li>`naverDaily` 네이버 Daily+</li></ul> |
|       **fanCount**        |    N     | number  |  null   | 100                                                                                                                | 웹툰의 팬 수<br/>10,000 단위 이며 10,000 이하일 경우 null                                                                                                                                                          |
|     **searchKeyword**     |    Y     | string  |    -    | 갓오브하이스쿨박용제                                                                                               | 검색에 사용되는 키워드                                                                                                                                                                                             |
|          **new**          |    Y     | boolean |  false  | true                                                                                                               | 신규 웹툰 여부                                                                                                                                                                                                     |
|         **adult**         |    Y     | boolean |  false  | true                                                                                                               | 성인 웹툰 여부                                                                                                                                                                                                     |
|         **rest**          |    Y     | boolean |  false  | true                                                                                                               | 웹툰 휴재 여부                                                                                                                                                                                                     |
|          **up**           |    Y     | boolean |  false  | true                                                                                                               | 웹툰 신규 회차 업로드 여부                                                                                                                                                                                         |
