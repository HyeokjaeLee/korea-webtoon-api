...
import { covid19Info, covid19API } from "./types";
const service_key: string = "LqdHrACABsYGuZOSxYS0G0hMAhheDZCNIPVR1zWxT5SxXvh3XmI9hUUjuzCgmq13GYhdyYgebB94yUVCB59bAg%3D%3D";
...
const process_covid19_region_data = (source_api_data: any[]) => {
  ...
  const categorized_by_region = () => {
    const result: any[][] = Array.from(Array(region_count), () => new Array());
